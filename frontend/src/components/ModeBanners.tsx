...
const BANNER_IMAGES: Record<string, any> = {
  ...
  "banner-saga-2": require("../../assets/images/banner_saga_2.png"),
  "banner-age-1": require("../../assets/images/banner_age_1.png"),
  "banner-age-2": require("../../assets/images/banner_age_2.png"),
  "banner-book-1": require("../../assets/images/banner_book_1.png"),
  "banner-book-2": require("../../assets/images/banner_book_2.png"),
