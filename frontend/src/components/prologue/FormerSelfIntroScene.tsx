 ...
 *
 * Opening: the overconfident Prodigy dismisses Master Bai, Nightingale,
 * and Fleming, then charges in alone — setting up the inevitable fall.
 *
 ...
 *   – Tap: skip typewriter → tap again → advance to next beat
 *   – Last beat has autoEnd: true — auto-advances 1.5 s after text finishes
 */
...
const BEATS: Beat[] = [
  { speaker: "MASTER_BAI",  line: "Something is wrong with this field. The corruption pattern is not what it should be." },
  { speaker: "PRODIGY",     line: "Master Bai. I have cleared this kind of threat before. A hundred times." },
  { speaker: "NIGHTINGALE", line: "Wait — let me run an observation scan first. The monitoring readings are behaving strangely." },
  { speaker: "PRODIGY",     line: "There is no time for scans. The corruption spreads while we stand and deliberate." },
  { speaker: "FLEMING",     line: "There are signs here we have not yet read. To act without assessing the resistance—" },
  { speaker: "PRODIGY",     line: "Enough. I am going in.", autoEnd: true },
];
