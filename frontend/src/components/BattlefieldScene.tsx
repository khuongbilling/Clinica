...
const styles = StyleSheet.create({
  ...
  heroUnitName: { color: COLORS.onSurfaceTertiary, fontSize: 12, fontWeight: "700", marginTop: 3 },
  ...
  tapHint: { color: COLORS.onSurfaceTertiary, fontSize: 12, fontWeight: "600", marginTop: 3, opacity: 0.8 },
  infoPanel: {
  ...
  infoRealWorld: { color: COLORS.onSurfaceSecondary, fontSize: 12, fontStyle: "italic" },
  infoClue: { color: COLORS.onSurface, fontSize: 13, lineHeight: 18 },
  infoClueLabel: { color: COLORS.onSurfaceTertiary, fontWeight: "700" },
  infoCounterRow: { marginTop: 2, gap: 1 },
  infoCounterLabel: { color: COLORS.onSurfaceTertiary, fontSize: 12, fontWeight: "700", letterSpacing: 0.3 },
  infoCounterVal: { fontSize: 12, fontWeight: "700" },
});
