...
export const SKINS: ShopSkin[] = [
  ...
  {
    id: 'skin_frostspire',
    name: 'Frostspire Sanctum',
    subtitle: 'Aurora Frost Ward',
    description: 'Swaps your Ward Shift arena for a crystalline ice sanctum lit by shimmering aurora, plus a cool cyan aura on your healers. Purely cosmetic — no effect on battle.',
    price: 600,
    auraColor: '#67e8f9',
    accentColor: '#0ea5e9',
    icon: 'snow',
    wardBackdrop: require('@/assets/images/battle_bg/frostspire.png'),
  },
  {
    id: 'skin_ember_forge',
    name: 'Ember Forge Hall',
    subtitle: 'Molten Forge Ward',
    description: 'Swaps your Ward Shift arena for a warm temple-forge infirmary aglow with molten ember light, plus a fiery amber aura on your healers. Purely cosmetic — no effect on battle.',
    price: 600,
    auraColor: '#fbbf24',
    accentColor: '#d97706',
    icon: 'bonfire',
    wardBackdrop: require('@/assets/images/battle_bg/ember_forge.png'),
  },
  {
    id: 'skin_celestial',
    name: 'Celestial Observatory',
    subtitle: 'Starlit Astral Ward',
    description: 'Swaps your Ward Shift arena for a moonlit cosmic observatory beneath drifting constellations, plus a dreamy violet aura on your healers. Purely cosmetic — no effect on battle.',
    price: 900,
    auraColor: '#c084fc',
    accentColor: '#7c3aed',
    icon: 'planet',
    wardBackdrop: require('@/assets/images/battle_bg/celestial.png'),
  },
];
