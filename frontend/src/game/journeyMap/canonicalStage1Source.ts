...
export const CANONICAL_STAGE1_SOURCES: Readonly<Record<number, CanonicalStage1Source>> =
  Object.freeze(Object.fromEntries(
    Object.entries(RAW_SOURCE).map(([chapter, source]) => [chapter, freezeSource(source)]),
  ));
