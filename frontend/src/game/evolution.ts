  ...
  Scout: [
    {
      ...
      shortEffect: 'Reveal 2 clues',
      beginnerExplanation: 'Quickly checks the patient for hidden signs or symptoms.',
      nclexExplanation: 'Rapid targeted assessment identifies early clinical findings that guide intervention priority.',
    },
    {
      ...
      beginnerExplanation: 'A careful head-to-toe check that also settles the patient.',
      nclexExplanation: 'Systematic head-to-toe assessment uncovers subtle findings while supportive monitoring maintains stability.',
    },
  ],
  Striker: [
    {
      ...
      shortEffect: 'Strike 18',
      beginnerExplanation: 'A strong, direct treatment that hits the problem hard.',
      nclexExplanation: 'Decisive targeted intervention addresses the primary pathology before it can escalate.',
    },
    {
      ...
      shortEffect: 'Strike 30',
      beginnerExplanation: 'A powerful all-out treatment that overwhelms the disease.',
      nclexExplanation: 'Aggressive evidence-based treatment rapidly reverses the pathological process at its source.',
    },
  ],
  Restorer: [
    {
      ...
      shortEffect: 'Stabilize +12',
      beginnerExplanation: 'Gentle consistent care keeps the patient stable and comfortable.',
      nclexExplanation: 'Consistent restorative nursing care maintains physiological homeostasis and prevents deterioration.',
    },
    {
      minStar: 5, key: 'healing_surge', name: 'Healing Surge', type: 'stabilize', cost: 2,
      base: { stabilize: 22, shield: 10 },
      description: 'A surge of restorative energy that heals and shields.',
      shortEffect: 'Stabilize +22 · Shield 10',
      beginnerExplanation: 'A strong healing burst that also protects the patient from the next threat.',
      nclexExplanation: 'Intensive restorative intervention corrects deficits while prophylactic measures reduce risk of further decompensation.',
    },
  ],
  Preventer: [
    {
      ...
      shortEffect: 'Shield 16',
      beginnerExplanation: 'Sets up a protective buffer before the next danger arrives.',
      nclexExplanation: 'Anticipatory preventive care reduces harm from the next incoming stressor.',
    },
    {
      minStar: 5, key: 'ward_seal', name: 'Ward Seal', type: 'shield', cost: 2,
      base: { shield: 22, stabilize: 8 },
      description: 'Seals the ward against harm while restoring stability.',
      shortEffect: 'Shield 22 · Stabilize +8',
      beginnerExplanation: 'A strong ward-wide protection that also steadies the patient.',
      nclexExplanation: 'Comprehensive infection and harm-prevention protocols protect the patient while supportive care maintains stability.',
    },
  ],
  SystemsLeader: [
    {
      ...
      beginnerExplanation: 'Directs the team to cover and care for the patient at the same time.',
      nclexExplanation: 'Effective delegation to appropriate staff members ensures simultaneous protective and supportive patient care.',
    },
    {
      ...
      beginnerExplanation: 'A skilled leader rallies the whole team to protect and heal the patient.',
      nclexExplanation: 'Systems-level leadership mobilizes interdisciplinary resources to provide concurrent protective and restorative interventions.',
    },
  ],
};
