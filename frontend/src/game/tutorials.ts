...
export const TUTORIALS: Record<TutorialId, TutorialStep[]> = {
  prologueBattle: [
    ...
    {
      id: "prologue_prodigy",
      title: "Step 5: The Prodigy Strikes",
      body: "The sequence is set. Scouted, stabilized, countered, reassessed. Now The Prodigy delivers the finishing blow. Use Cascade Protocol — mythic authority, complete care, overwhelming result.",
      placement: "center",
      requireAction: true,
    ...
    },
    {
      ...
      body: "That's the care chain. Five steps, every shift. Each healer has a role. None are passengers. The patient is safe. You did this.",
      placement: "center",
      requireAction: false,
