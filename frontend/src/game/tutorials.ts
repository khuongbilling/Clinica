...
export const TUTORIALS: Record<TutorialId, TutorialStep[]> = {
  prologueBattle: [
    ...
    },
    {
      ...
      nextText: "USE MYTHIC PRESCIENCE",
    },
    {
      id: "prologue_endturn",
      title: "Pass the Time",
    ...
    },
    {
      ...
      body: "The disease hit back. Now check what changed. Fleming's Reassess catches what you might have missed — and weakens the Corruption further. One more push and the patient is in reach.",
      placement: "center",
      requireAction: true,
  ...
  firstBattle: [
    ...
    },
    {
      ...
      body: "Shore up their Stability before pushing back. Use a Stabilize skill.",
      placement: "center",
      requireAction: false,
      nextText: "GOT IT",
    },
