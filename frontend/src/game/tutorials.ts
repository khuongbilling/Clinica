...
export const TUTORIALS: Record<TutorialId, TutorialStep[]> = {
  prologueBattle: [
    {
      ...
      body: "Look at those two bars above. The green one is Stability — how safe the patient is right now. If it hits zero, you lose. The red bar is Corruption — how far the disease has taken hold. Bring that to zero and the patient recovers. Your objective is pinned below the bars. I will walk you through every step.",
      placement: "bottom",
      requireAction: false,
      banner: true,
      nextText: "I'M READY",
    ...
    {
      id: "prologue_cue",
      title: "Read This Before Acting",
      body: "A clinical question has appeared below this panel. That is your Clinical Cue — it is directly about what this disease is doing to your patient right now. Read it carefully. A correct answer will strengthen everything you do this turn. Tap here first, then answer the question below.",
      placement: "top",
      requireAction: true,
    ...
    {
      id: "prologue_prodigy_turn1",
      title: "Step 3: The Prodigy Commands",
      body: "Three healers. One battlefield. Nightingale assessed, Fleming stabilized — now The Prodigy seizes the ward. Ward Dominion floods every system at once. This is mythic authority.",
      placement: "center",
      requireAction: true,
      requiredSkillId: "ward_dominion",
      nextText: "USE WARD DOMINION",
    },
    {
      id: "prologue_endturn",
      title: "Pass the Time",
      body: "All three healers have done what they can this turn. End the turn and let the team reset. Disease doesn't wait. Neither should you.",
      placement: "center",
      requireAction: true,
    ...
    },
    {
      ...
      body: "Never assume improvement. Confirm it. Fleming's Reassess will check on the patient and close the care chain.",
      placement: "center",
      requireAction: true,
    ...
    {
      id: "prologue_prodigy",
      title: "Step 6: The Prodigy Finishes It",
      body: "Scouted. Stabilized. Commanded. Countered. Reassessed. The sequence is complete. Now The Prodigy delivers the finishing blow. Cascade Protocol — overwhelming care, all at once.",
      placement: "center",
      requireAction: true,
    ...
    {
      id: "prologue_done",
      title: "Scout. Stabilize. Command. Counter. Reassess. Finish.",
      body: "That's the care chain. Six steps, every shift. Each healer has a role. None are passengers. The patient is safe. You did this.",
      placement: "center",
      requireAction: false,
  ...
  firstBattle: [
    {
      id: "fb_intro",
      title: "Something is wrong with this case.",
      body: "Notice the Corruption bar. It reads ???. This disease is not showing its hand — atypical presentation. You cannot see how far it has taken hold. The only reliable signal you have is Stability. Watch it. It is already dropping.",
      placement: "bottom",
      requireAction: false,
      banner: true,
      nextText: "BEGIN",
    ...
    {
      id: "fb_scout",
      title: "Look first — always.",
      body: "Even when the numbers lie, assessment still matters. Scout the patient. Find what the Corruption bar won't tell you.",
      placement: "center",
      requireAction: true,
    ...
    {
      id: "fb_stabilize",
      title: "Stability is the only truth here.",
      body: "Corruption is unreadable. Stability is not. Shore it up before it collapses — Stabilize the patient now.",
      placement: "center",
      requireAction: true,
    ...
    {
      id: "fb_counter",
      title: "Strike the disease — even blind.",
      body: "You cannot see the Corruption level, but you can still fight it. Use a Counter skill. It may not show on the bar. Keep going.",
      placement: "center",
      requireAction: true,
      requiredActionType: "strike",
      nextText: "USE A COUNTER SKILL",
    },
    {
      id: "fb_reassess",
      title: "Stability keeps falling. Reassess.",
      body: "Your interventions are landing. The disease is not responding the way it should. Reassess — confirm what you know, close the chain.",
      placement: "center",
      requireAction: true,
      requiredActionType: "analyze",
      nextText: "USE A REASSESS SKILL",
    },
    {
      id: "fb_done",
      title: "You did everything right.",
      body: "You scouted. You stabilized. You countered blind. You reassessed. This case was always going to collapse — a silent infarction that no bar could measure. The outcome was written before you arrived. This is the moment before the Recall.",
      placement: "center",
      requireAction: false,
      nextText: "UNDERSTOOD",
    },
