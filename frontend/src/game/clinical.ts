...
export const ITEM_CLINICAL: Record<string, ActionClinical> = {
  ...
  'Antiemetic Charm': {
    ...
    appropriateForSystems: ['Filter / Renal'],
    pathwayRoles: ['treat'],
    diseaseCategory: 'general',
  },
};
...
export const ENEMY_CLINICAL: Record<string, EnemyClinical> = {
  ...
  dehydration_specter: {
    ...
    chainAdvanceTags: ['safety', 'antipyretic', 'de-escalation', 'dysrhythmia', 'treatment'],
    weaknesses: ['River'],
    resistances: ['Fire'],
    starTurnLimit: 5,
    rewardBase: 35,
  ...
  air_sprite: {
    ...
    chainAdvanceTags: ['therapeutic communication', 'circulation', 'safety', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'treatment'],
    weaknesses: ['Air'],
  ...
  river_sludge: {
    ...
    chainAdvanceTags: ['safety', 'infection isolation', 'airway', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'oxygenation', 'treatment'],
    weaknesses: ['River'],
    resistances: ['Fire', 'Mind'],
    starTurnLimit: 5,
    rewardBase: 25,
  ...
  energy_lock: {
    ...
    chainAdvanceTags: ['circulation', 'safety', 'airway', 'antipyretic', 'antiemetic', 'treatment'],
    weaknesses: ['Energy'],
  ...
  fire_imp: {
    ...
    chainAdvanceTags: ['safety', 'general support', 'skin integrity', 'circulation', 'airway', 'antipyretic', 'antiemetic', 'treatment'],
  ...
  fever_shade: {
    ...
    chainAdvanceTags: ['infection isolation', 'circulation', 'safety', 'airway', 'treatment'],
  ...
  mind_fog: {
    ...
    chainAdvanceTags: ['infection isolation', 'skin integrity', 'circulation', 'airway', 'antipyretic', 'antiemetic', 'treatment'],
  ...
  septara_seed: {
    ...
    chainAdvanceTags: ['general support', 'safety', 'airway', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'oxygenation', 'treatment'],
  ...
  cardion_echo: {
    ...
    chainAdvanceTags: ['safety', 'infection isolation', 'circulation', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'treatment'],
  ...
  glycora_spark: {
    ...
    chainAdvanceTags: ['general support', 'safety', 'infection isolation', 'airway', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'oxygenation', 'treatment'],
  ...
  ward_cascade: {
    ...
    chainAdvanceTags: ['safety', 'antipyretic', 'antiemetic', 'treatment'],
  ...
  lord_imbalance: {
    ...
    chainAdvanceTags: ['general support', 'safety', 'infection isolation', 'antipyretic', 'de-escalation', 'dysrhythmia', 'hydration', 'antiemetic', 'analgesia', 'treatment'],
  ...
  hypoxia_wisp: {
    ...
    chainAdvanceTags: ['circulation', 'therapeutic communication', 'de-escalation', 'dysrhythmia', 'hydration', 'analgesia'],
    weaknesses: ['Air'],
    resistances: [],
    starTurnLimit: 4,
    rewardBase: 12,
  ...
  panic_wraith: {
    ...
    chainAdvanceTags: ['safety', 'circulation', 'airway', 'de-escalation', 'dysrhythmia', 'hydration', 'oxygenation'],
    weaknesses: ['Mind'],
    resistances: [],
    starTurnLimit: 4,
    rewardBase: 10,
  ...
  shock_spike: {
    ...
    chainAdvanceTags: ['therapeutic communication', 'airway', 'de-escalation', 'dysrhythmia', 'hydration', 'analgesia', 'oxygenation'],
    weaknesses: ['River'],
    resistances: [],
    starTurnLimit: 4,
    rewardBase: 15,
...
export function computeStars(scoring: BattleScoring, rules: StarRules): { stars: number; details: string[] } {
  ...
  const assistanceCriteriaMet = consultsOk && noEmergency && noInappropriate;
  if (scoring.won && assistanceCriteriaMet && (scoring.fullChainCompleted || efficiencyCriteriaMet)) {
    stars++;
