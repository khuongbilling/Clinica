...
export const HEROES: Hero[] = [
  ...
  // tutorials.ts.  They are never persisted in heroes_owned or active_team.
  {
    ...
    skills: [
      ...
      { id: 'breath_of_dawn', name: 'Breath of Dawn', type: 'stabilize', systemType: 'Air', cost: 6, description: 'Legendary oxygenation surge. +90 Stability, -60 Corruption (Air).', shortEffect: 'Air Treatment • +90 Stability · -60 Corruption', rpgDescription: 'A radiant breath from Nightingale floods the ward with healing air; the patient surges back from the edge.', beginnerExplanation: 'A massive wave of breathing support and direct damage to the problem.', nclexExplanation: 'Comprehensive respiratory intervention: supplemental O₂, positioning, airway management, and escalation, delivered at legendary speed.', stabilize: 90, strike: 60 },
