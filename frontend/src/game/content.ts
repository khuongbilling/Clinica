...
export const HEROES: Hero[] = [
  ...
  // tutorials.ts.  They are never persisted in heroes_owned or active_team.
  {
    ...
    bondExp: 0,
    skills: [
      { id: 'lantern_of_clues', name: 'Lamp of Observation', type: 'scout', systemType: 'Universal', cost: 2, description: 'Legendary assessment. Reveal 2 hidden clues. -20 Corruption.', shortEffect: 'Scout • Reveal 2 Clues · -20 Corruption', rpgDescription: "Nightingale's lamp blazes across the ward, catching every detail corruption tried to hide.", beginnerExplanation: 'Look closer. A legendary eye sees twice as much.', nclexExplanation: 'Expert clinical assessment: pattern recognition across thousands of cases allows identification of multiple critical cues simultaneously.', reveal: 2, strike: 20 },
      { id: 'breath_of_dawn', name: 'Breath of Dawn', type: 'stabilize', systemType: 'Air', cost: 4, description: 'Legendary oxygenation surge. +90 Stability, -60 Corruption (Air).', shortEffect: 'Air Treatment • +90 Stability · -60 Corruption', rpgDescription: 'A radiant breath from Nightingale floods the ward with healing air; the patient surges back from the edge.', beginnerExplanation: 'A massive wave of breathing support and direct damage to the problem.', nclexExplanation: 'Comprehensive respiratory intervention: supplemental O₂, positioning, airway management, and escalation, delivered at legendary speed.', stabilize: 90, strike: 60 },
      { id: 'rapid_response', name: 'Rapid Response', type: 'stabilize', systemType: 'Universal', cost: 5, description: 'Legendary emergency surge. +130 Stability, Protection 60.', shortEffect: 'Stabilize • +130 Stability · Protection 60', rpgDescription: "Nightingale surges in with centuries of practiced calm; the patient stabilises, protected by her aura.", beginnerExplanation: 'The biggest support possible: enormous Stability gain and Protection against the next Instability event.', nclexExplanation: 'Rapid team-based escalation: coordinated stabilisation with real-time protection against further deterioration.', stabilize: 130, shield: 60 },
    ],
  },
  {
    id: 'prologue_fleming',
    ...
    bondExp: 0,
    skills: [
      { id: 'guardians_touch', name: "Guardian's Touch", type: 'support', systemType: 'Universal', cost: 3, description: 'Legendary steady support. +70 Stability, -20 Corruption.', shortEffect: 'Universal Treatment • +70 Stability · -20 Corruption', rpgDescription: "Fleming's legendary steady hand restores deep balance and hammers back the corruption.", beginnerExplanation: 'A powerful wave of care that heals and fights the problem at once.', nclexExplanation: 'Legendary fundamental care: advanced repositioning, precision hygiene, therapeutic touch, and proactive monitoring at expert intensity.', stabilize: 70, strike: 20 },
      { id: 'reassess', name: 'Reassess', type: 'analyze', systemType: 'Universal', cost: 2, description: 'Reveal 2 clues. Expert insight -55 Corruption.', shortEffect: 'Analyze • Reveal 2 Clues · -55 Corruption', rpgDescription: "Fleming returns with a scientist's legendary eye, finding every missed detail and striking at the corruption's heart.", beginnerExplanation: 'Legendary observation: catches two missed steps and weakens the enemy significantly.', nclexExplanation: 'Expert reassessment closes care gaps rapidly. At legendary skill, identifying multiple missed interventions produces immediate, dramatic reduction in disease burden.', reveal: 2, strike: 55 },
      { id: 'glucose_round', name: 'Culture & Sensitivity', type: 'strike', systemType: 'Energy', cost: 4, description: 'Expert targeted therapy. -96 Corruption (Energy). Reveal 2 clues.', shortEffect: 'Energy Counter • -96 Corruption · Reveal 2 Clues', rpgDescription: "Fleming reads the culture instantly; targeted legendary therapy shatters the Corruption's hold.", beginnerExplanation: 'Identify the exact problem with precision and deliver a massive Corruption reduction.', nclexExplanation: 'Culture and sensitivity-guided targeted antimicrobial therapy: at legendary skill, the strike is immediate and overwhelming.', strike: 96, reveal: 2 },
    ],
  },
  {
    ...
    bondExp: 0,
    skills: [
      { id: 'ward_dominion', name: 'Ward Dominion', type: 'stabilize', systemType: 'Universal', cost: 4, description: 'Mythic ward mastery. +130 Stability, -30 Corruption.', shortEffect: 'Universal • +130 Stability · -30 Corruption', rpgDescription: 'The Prodigy sweeps the ward with mythic authority; stability floods back and corruption shatters.', beginnerExplanation: 'A massive wave of mythic healing that stabilises the patient and destroys the problem.', nclexExplanation: 'Comprehensive multi-system stabilisation: airway, circulation, labs, pain, and monitoring addressed simultaneously by a mythic team leader.', stabilize: 130, strike: 30 },
      { id: 'mythic_prescience', name: 'Mythic Prescience', type: 'counter', systemType: 'Universal', cost: 2, description: 'Read the disease before it acts. Anticipate the next deterioration, reveal 2 clues, and strike the Corruption for -50.', shortEffect: 'Counter • Anticipate Pattern · Reveal 2 Clues · -50 Corruption', rpgDescription: 'The Prodigy sees what is coming before it arrives — a preemptive strike that cuts through Corruption the moment the pattern is recognised.', beginnerExplanation: 'Read the warning signs and act first. Recognising what the disease will do next lets you counter it before it happens.', nclexExplanation: 'Anticipatory clinical reasoning: expert nurses recognise deterioration patterns from subtle early cues and intervene preemptively, directly reducing disease burden before it escalates.', reveal: 2, strike: 50 },
      { id: 'cascade_protocol', name: 'Cascade Protocol', type: 'stabilize', systemType: 'Universal', cost: 5, description: 'The legendary cascade. +180 Stability, -120 Corruption, Protection 70.', shortEffect: 'Mythic • +180 Stability · -120 Corruption · Protection 70', rpgDescription: 'All systems stabilise simultaneously. Corruption collapses. The ward remembers who is in charge.', beginnerExplanation: 'The ultimate move: mythic Stability restoration, overwhelming Corruption reduction, and Protection all at once.', nclexExplanation: 'Coordinated multi-disciplinary rapid response: full team-based stabilisation with simultaneous treatment, monitoring escalation, and protective measures at mythic scale.', stabilize: 180, strike: 120, shield: 70 },
    ],
  },
  {
    id: 'storm_runner',
  ...
  // ── LEGENDARY (locked, not in gacha pool) ─────────────────────────────────
  {
    ...
    skills: [
      ...
      },
      {
        ...
        shortEffect: 'Fire Counter • −24 Corruption · Reveal All',
...
export const ENEMIES: Enemy[] = [
  {
    ...
    visibleClues: [
      ...
      { id: 'c2', label: 'Intense Thirst', detail: 'Patient is desperate for water. Compensatory drive.', hidden: false },
      { id: 'c3', label: 'Marked Fatigue', detail: 'Low energy, drowsy, struggling to stay alert.', hidden: false },
    ],
    hiddenClues: [
    ...
    dangerTrigger: 'Circulatory collapse from hypovolemic shock',
...
export const BATTLE_MECHANICS: MechanicInfo[] = [
  ...
  { id: 'care_chain', icon: 'link', title: 'The Care Chain', body: 'Playing Scout → Stabilize → Counter in order completes a Care Chain for a big bonus. Following the nursing process is rewarded; rushing straight to Strike actions is not.' },
