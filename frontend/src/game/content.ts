...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    bondExp: 0,
    skills: [
      { id: 'ward_dominion', name: 'Ward Dominion', type: 'stabilize', systemType: 'Universal', cost: 2, description: 'Mythic ward mastery. +65 Stability, -30 Corruption.', shortEffect: 'Universal • +65 Stability · -30 Corruption', rpgDescription: 'The Prodigy sweeps the ward with mythic authority; stability floods back and corruption shatters.', beginnerExplanation: 'A massive wave of mythic healing that stabilises the patient and destroys the problem.', nclexExplanation: 'Comprehensive multi-system stabilisation: airway, circulation, labs, pain, and monitoring addressed simultaneously by a mythic team leader.', stabilize: 65, strike: 30 },
      { id: 'mythic_prescience', name: 'Mythic Prescience', type: 'counter', systemType: 'Universal', cost: 1, description: 'Read the disease before it acts. Anticipate the next deterioration, reveal 2 clues, and strike the Corruption for -35.', shortEffect: 'Counter • Anticipate Pattern · Reveal 2 Clues · -35 Corruption', rpgDescription: 'The Prodigy sees what is coming before it arrives — a preemptive strike that cuts through Corruption the moment the pattern is recognised.', beginnerExplanation: 'Read the warning signs and act first. Recognising what the disease will do next lets you counter it before it happens.', nclexExplanation: 'Anticipatory clinical reasoning: expert nurses recognise deterioration patterns from subtle early cues and intervene preemptively, directly reducing disease burden before it escalates.', reveal: 2, strike: 35 },
