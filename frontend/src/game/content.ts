...
export const HEROES: Hero[] = [
  ...
  // ── EPIC (rarity 4) — second wave ────────────────────────────────────────
  {
    ...
    skills: [
      { id: 'lcc_lotus_vigil', name: 'Lotus Vigil', type: 'analyze', systemType: 'Universal', cost: 1, description: 'Master assessment reveals the complete clinical picture. Reveal all clues, Stabilize +10.', shortEffect: 'Reveal All · Stabilize +10', rpgDescription: 'The Captain surveys the full ward; every hidden threat surfaces under her practiced eye.', beginnerExplanation: 'A full assessment by an expert nurse reveals everything that matters.', nclexExplanation: 'Expert pattern recognition and comprehensive assessment form the foundation of advanced nursing judgment.', reveal: 99, stabilize: 10 },
      { id: 'lcc_care_cascade', name: 'Care Cascade', type: 'stabilize', systemType: 'River', cost: 2, description: 'Master-level ward care reverses critical deterioration. Stabilize +34.', shortEffect: 'Stabilize +34', rpgDescription: 'A cascade of expert care flows from the Captain; the patient steadies at every level.', beginnerExplanation: 'A skilled nurse\'s expert care is among the most powerful stabilizing forces in medicine.', nclexExplanation: 'Advanced nursing intervention: complex medication management, hemodynamic monitoring, family coordination, all drive patient recovery.', stabilize: 34 },
      { id: 'lcc_ward_command', name: 'Ward Command', type: 'command', systemType: 'River', cost: 3, description: 'Full ward mobilization. -20 Corruption, Protection 90, +16 Stability.', shortEffect: 'Strike 20 · Protection 90 · Stabilize +16', rpgDescription: 'The Captain calls every resource at once; corruption falls and the ward holds.', beginnerExplanation: 'A captain-level nurse directs every resource at once to lower Corruption and restore Stability.', nclexExplanation: 'Charge nurse leadership coordinates interdisciplinary team response, delegates effectively, and ensures simultaneous treatment and protection.', strike: 20, shield: 90, stabilize: 16 },
    ],
  },
  {
    id: 'code_guardian',
    ...
    skills: [
      { id: 'cg_code_call', name: 'Code Call', type: 'command', systemType: 'Universal', cost: 1, description: 'Rapid response activation. Reveal 2 clues, +12 Stability.', shortEffect: 'Reveal 2 · Stabilize +12', rpgDescription: 'The Guardian calls the code team; hidden threats surface and the patient steadies.', beginnerExplanation: 'Calling the code team reveals the full picture fast.', nclexExplanation: 'Rapid response team activation uses SBAR to communicate deterioration and mobilize appropriate resources immediately.', reveal: 2, stabilize: 12 },
      { id: 'cg_defib_strike', name: 'Defib Strike', type: 'strike', systemType: 'River', cost: 2, description: 'High-energy resuscitative intervention. -28 Corruption, +14 Stability.', shortEffect: 'Strike 28 · Stabilize +14', rpgDescription: 'A controlled shock reverses the lethal rhythm; the patient surges back.', beginnerExplanation: 'A powerful resuscitation intervention hits the crisis and stabilizes at once.', nclexExplanation: 'Defibrillation and synchronized cardioversion terminate lethal arrhythmias, restoring cardiac output and hemodynamic stability.', strike: 28, stabilize: 14 },
  ...
  },
  {
    ...
    skills: [
      { id: 'psa_system_audit', name: 'System Audit', type: 'analyze', systemType: 'Universal', cost: 1, description: 'Institution-wide safety assessment. Reveal all clues, +14 Stability.', shortEffect: 'Reveal All · Stabilize +14', rpgDescription: 'The Arbiter surveys every system; every risk surfaces and the patient steadies.', beginnerExplanation: 'A full system safety audit reveals every risk and begins healing at every level.', nclexExplanation: 'Healthcare safety audit combines structural indicators, process measures, and outcome data to identify systemic vulnerabilities before they cause harm.', reveal: 99, stabilize: 14 },
      { id: 'psa_arbiter_strike', name: 'Arbiter Strike', type: 'strike', systemType: 'Protection', cost: 2, description: 'System-level intervention eliminates risk. -32 Corruption, Protection 85.', shortEffect: 'Strike 32 · Protection 85', rpgDescription: 'A precision system intervention cuts out the failure pathway before it reaches the patient.', beginnerExplanation: 'A system-wide safety intervention powerfully lowers Corruption and prevents the next Stability loss event.', nclexExplanation: 'High-reliability organization interventions: forcing functions, standardization, redundancy; eliminate error pathways at the system level.', strike: 32, shield: 85 },
      { id: 'psa_safety_realm', name: 'Safety Realm', type: 'command', systemType: 'Protection', cost: 3, description: 'Full institution safety command. Protection 100, -22 Corruption, block Corruption Spread.', shortEffect: 'Protection 100 · Strike 22 · Block Spread', rpgDescription: 'The Arbiter commands every system at once; no harm reaches this ward today.', beginnerExplanation: 'A chief safety officer commanding all institutional safety systems creates complete Protection.', nclexExplanation: 'Comprehensive high-reliability systems combine zero-harm culture, real-time safety data, just culture reporting, and leadership accountability.', shield: 100, strike: 22, blockSpread: true },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      { id: 'ha_master_dx', name: 'Master Diagnosis', type: 'analyze', systemType: 'Mind', cost: 1, description: 'Expert clinical synthesis. Reveal all clues, +14 Stability.', shortEffect: 'Reveal All · Stabilize +14', rpgDescription: 'The Attending synthesizes every finding; the diagnosis crystallizes and the patient steadies.', beginnerExplanation: 'A master physician\'s diagnosis reveals every important finding and begins the recovery.', nclexExplanation: 'Expert attending-level synthesis integrates history, physical examination, investigations, and response to treatment into a unified clinical conclusion.', reveal: 99, stabilize: 14 },
      { id: 'ha_clinical_mastery', name: 'Clinical Mastery', type: 'strike', systemType: 'Mind', cost: 2, description: 'Masterful targeted treatment. -30 Corruption, +14 Stability.', shortEffect: 'Strike 30 · Stabilize +14', rpgDescription: 'The Attending prescribes with precision; treatment strikes at the disease\'s core.', beginnerExplanation: 'A master physician\'s precise treatment powerfully fights the disease and stabilizes the patient.', nclexExplanation: 'Evidence-based targeted therapy at the attending level applies the best available evidence to the individual patient context.', strike: 30, stabilize: 14 },
      { id: 'ha_hearthline', name: 'Hearthline', type: 'command', systemType: 'Universal', cost: 3, description: 'Full attending-level ward command. Protection 90, -20 Corruption, +16 Stability.', shortEffect: 'Protection 90 · Strike 20 · Stabilize +16', rpgDescription: 'The Attending takes command of the service; every system rallies and corruption retreats.', beginnerExplanation: 'A senior physician taking command of the whole situation is the most powerful clinical intervention.', nclexExplanation: 'Attending-led interdisciplinary care coordination simultaneously addresses treatment, prevention, and team communication.', shield: 90, strike: 20, stabilize: 16 },
    ],
  },
