...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'cascade_protocol', name: 'Cascade Protocol', type: 'stabilize', systemType: 'Universal', cost: 3, description: 'The legendary cascade. +90 Stability, -50 Corruption, Protection 35.', shortEffect: 'Mythic • +90 Stability · -50 Corruption · Protection 35', rpgDescription: 'All systems stabilise simultaneously. Corruption collapses. The ward remembers who is in charge.', beginnerExplanation: 'The ultimate move — mythic Stability restoration, massive Corruption reduction, and Protection all at once.', nclexExplanation: 'Coordinated multi-disciplinary rapid response: full team-based stabilisation with simultaneous treatment, monitoring escalation, and protective measures at mythic scale.', stabilize: 90, strike: 50, shield: 35 },
    ],
  },
  {
    id: 'storm_runner',
