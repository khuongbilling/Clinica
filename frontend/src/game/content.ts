...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    skills: [
      { id: 'vital_ward', name: 'Vital Ward', type: 'scout', systemType: 'Universal', cost: 1, description: 'Reveal a clue and steady the patient.', shortEffect: 'Scout • Reveal 1 · +8–11 Stability', rpgDescription: 'A watchful ward steadies the patient while clues surface.', beginnerExplanation: 'A careful check that also helps the patient feel better.', nclexExplanation: 'Frequent reassessment can catch early changes and prompt timely interventions.', reveal: 1, stabilize: 8, stabilizeRange: [8, 11] as [number,number] },
      { id: 'rally_bell', name: 'Rally Bell', type: 'command', systemType: 'Universal', cost: 2, description: 'Summon support. -20 Corruption, +10 Stability.', shortEffect: 'Command • −20–24 Corruption · +10–13 Stability', rpgDescription: 'A silver bell summons nearby healers to steady the crisis.', beginnerExplanation: 'Call for help when the situation is getting worse. A coordinated response hits harder.', nclexExplanation: 'Escalation is appropriate when patient status is unstable, worsening, or beyond what can be safely managed alone. A timely call directly reduces disease burden.', strike: 20, stabilize: 10, strikeRange: [20, 24] as [number,number], stabilizeRange: [10, 13] as [number,number] },
    ],
  },
  {
    id: 'apprentice_seer',
  ...
  },
  {
    ...
    skills: [
      { id: 'infection_scan', name: 'Infection Scan', type: 'scout', systemType: 'Fire', cost: 1, description: 'Reveal infection clues + strike 10.', shortEffect: 'Fire Scout • Reveal + Strike 10–13', rpgDescription: 'A practiced eye scans for the source of the corruption.', beginnerExplanation: 'Look for where the infection is coming from.', nclexExplanation: 'Source identification is critical for infection management. Look for wounds, lines, lungs, and urine as common sources.', reveal: 1, strike: 10, strikeRange: [10, 13] as [number,number] },
