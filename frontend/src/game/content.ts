...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    skills: [
      { id: 'skin_shield', name: 'Skin Shield', type: 'shield', systemType: 'Protection', cost: 1, description: 'Brace for the next enemy attack — it deals 45% less damage to Stability.', shortEffect: 'Shield • −45% next attack', rpgDescription: 'A weave of healing knits the barrier before harm arrives.', beginnerExplanation: 'Protect the skin and body from harm.', nclexExplanation: 'Maintain skin integrity through positioning, pressure relief, and barrier care to prevent breakdown.', shield: 45 },
