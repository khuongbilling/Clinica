...
export const HEROES: Hero[] = [
  ...
  // tutorials.ts.  They are never persisted in heroes_owned or active_team.
  {
    ...
    bondExp: 0,
    skills: [
      { id: 'lantern_of_clues', name: 'Lamp of Observation', type: 'scout', systemType: 'Universal', cost: 1, description: 'Legendary assessment. Reveal 2 hidden clues. -15 Corruption.', shortEffect: 'Scout • Reveal 2 Clues · -15 Corruption', rpgDescription: "Nightingale's lamp blazes across the ward, catching every detail corruption tried to hide.", beginnerExplanation: 'Look closer — a legendary eye sees twice as much.', nclexExplanation: 'Expert clinical assessment: pattern recognition across thousands of cases allows identification of multiple critical cues simultaneously.', reveal: 2, strike: 15 },
      { id: 'breath_of_dawn', name: 'Breath of Dawn', type: 'stabilize', systemType: 'Air', cost: 2, description: 'Legendary oxygenation surge. +45 Stability, -28 Corruption (Air).', shortEffect: 'Air Treatment • +45 Stability · -28 Corruption', rpgDescription: 'A radiant breath from Nightingale floods the ward with healing air — the patient surges back from the edge.', beginnerExplanation: 'A massive wave of breathing support and direct damage to the problem.', nclexExplanation: 'Comprehensive respiratory intervention: supplemental O₂, positioning, airway management, and escalation — delivered at legendary speed.', stabilize: 45, strike: 28 },
      { id: 'rapid_response', name: 'Rapid Response', type: 'stabilize', systemType: 'Universal', cost: 3, description: 'Legendary emergency surge. +60 Stability, +20 Shield.', shortEffect: 'Stabilize • +60 Stability · +20 Shield', rpgDescription: "Nightingale surges in with centuries of practiced calm — the patient stabilises, protected by her aura.", beginnerExplanation: 'The biggest support possible — huge healing and a protective barrier.', nclexExplanation: 'Rapid team-based escalation: coordinated stabilisation with real-time protection against further deterioration.', stabilize: 60, shield: 20 },
    ],
  },
  {
    id: 'prologue_fleming',
    ...
    bondExp: 0,
    skills: [
      { id: 'guardians_touch', name: "Guardian's Touch", type: 'support', systemType: 'Universal', cost: 2, description: 'Legendary steady support. +35 Stability, -25 Corruption.', shortEffect: 'Universal Treatment • +35 Stability · -25 Corruption', rpgDescription: "Fleming's legendary steady hand restores deep balance and hammers back the corruption.", beginnerExplanation: 'A powerful wave of care that heals and fights the problem at once.', nclexExplanation: 'Legendary fundamental care: advanced repositioning, precision hygiene, therapeutic touch, and proactive monitoring at expert intensity.', stabilize: 35, strike: 25 },
      { id: 'reassess', name: 'Reassess', type: 'scout', systemType: 'Universal', cost: 1, description: 'Reveal 2 clues. Expert insight -30 Corruption.', shortEffect: 'Scout • Reveal 2 Clues · -30 Corruption', rpgDescription: "Fleming returns with a scientist's legendary eye — finding every missed detail and striking at the corruption's heart.", beginnerExplanation: 'Legendary observation: catches two missed steps and weakens the enemy significantly.', nclexExplanation: 'Expert reassessment closes care gaps rapidly. At legendary skill, identifying multiple missed interventions produces immediate, dramatic reduction in disease burden.', reveal: 2, strike: 30 },
      { id: 'glucose_round', name: 'Culture & Sensitivity', type: 'strike', systemType: 'Energy', cost: 2, description: 'Expert targeted therapy. -48 Corruption (Energy). Reveal 2 clues.', shortEffect: 'Energy Counter • -48 Corruption · Reveal 2 Clues', rpgDescription: "Fleming reads the culture instantly — targeted legendary therapy shatters the corruption's defences.", beginnerExplanation: 'Identify the exact problem with precision and deal massive damage.', nclexExplanation: 'Culture and sensitivity-guided targeted antimicrobial therapy: at legendary skill, the strike is immediate and overwhelming.', strike: 48, reveal: 2 },
    ],
  },
  {
    ...
    role: 'Striker',
    element: 'Storm',
    description: 'The peak of clinical mastery. A healer who reached the summit — and forgot that wisdom matters more than power.',
    faction: 'Clinica',
    quote: 'I have seen every disease. None have beaten me. None will.',
    backstory: 'At their peak, the Former Self commanded every element and technique of the healing arts. Their power is undeniable — but power without wisdom is the seed of every tragedy.',
    bestAgainst: 'Universal',
    medicalFocus: 'Comprehensive mastery, multi-system support, mythic intervention',
    bondLevel: 0,
    bondExp: 0,
    skills: [
      { id: 'ward_dominion', name: 'Ward Dominion', type: 'stabilize', systemType: 'Universal', cost: 2, description: 'Mythic ward mastery. +65 Stability, -30 Corruption.', shortEffect: 'Universal • +65 Stability · -30 Corruption', rpgDescription: 'The Former Self sweeps the ward with mythic authority — stability floods back and corruption shatters.', beginnerExplanation: 'A massive wave of mythic healing that stabilises the patient and destroys the problem.', nclexExplanation: 'Comprehensive multi-system stabilisation: airway, circulation, labs, pain, and monitoring addressed simultaneously by a mythic team leader.', stabilize: 65, strike: 30 },
      { id: 'mythic_prescience', name: 'Mythic Prescience', type: 'scout', systemType: 'Universal', cost: 1, description: 'Intuition beyond training. Reveal 2 clues. -35 Corruption.', shortEffect: 'Scout • Reveal 2 Clues · -35 Corruption', rpgDescription: 'The Former Self reads the patient in an instant — seeing through every hidden detail at once.', beginnerExplanation: 'Instantly reveals hidden clues and strikes the enemy with mythic force.', nclexExplanation: 'Expert clinical intuition: pattern recognition from thousands of cases allows immediate identification of every critical cue others would miss.', reveal: 2, strike: 35 },
      { id: 'cascade_protocol', name: 'Cascade Protocol', type: 'stabilize', systemType: 'Universal', cost: 3, description: 'The legendary cascade. +90 Stability, -50 Corruption, +35 Shield.', shortEffect: 'Mythic • +90 Stability · -50 Corruption · +35 Shield', rpgDescription: 'All systems stabilise simultaneously. Corruption collapses. The ward remembers who is in charge.', beginnerExplanation: 'The ultimate move — mythic healing, a massive shield, and overwhelming damage all at once.', nclexExplanation: 'Coordinated multi-disciplinary rapid response: full team-based stabilisation with simultaneous treatment, monitoring escalation, and protective measures at mythic scale.', stabilize: 90, strike: 50, shield: 35 },
    ],
  },
  {
    id: 'storm_runner',
