...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    skills: [
      { id: 'mind_anchor', name: 'Mind Anchor', type: 'cleanse', systemType: 'Mind', cost: 1, description: 'Cleanse status effects + stabilize 8. De-escalation reduces Mind Corruption (-12).', shortEffect: 'Mind Treatment • +8 Stability · -12 Corruption', rpgDescription: 'A steady voice anchors the patient — and the corruption of confusion loses its grip.', beginnerExplanation: 'Calming the patient actively fights Mind-type disease processes.', nclexExplanation: 'Therapeutic communication and de-escalation are active clinical interventions — they directly reduce the neurological and psychological disease burden in delirium and mental health crises.', cleanse: true, stabilize: 8, strike: 12 },
