...
export const HEROES: Hero[] = [
  {
    ...
    skills: [
      ...
      { id: 'rapid_response', name: 'Rapid Response', type: 'stabilize', systemType: 'Universal', cost: 2, description: 'Emergency support. +40 Stability.', shortEffect: 'Stabilize • +40 Stability', rpgDescription: 'The healer surges in with practiced calm — the patient pulls back from the edge.', beginnerExplanation: 'A big push of support when the patient is in trouble.', nclexExplanation: 'Recognize deterioration and escalate care. Rapid intervention can stabilize an acutely unstable patient.', stabilize: 40 },
    ],
  },
  {
    id: 'night_watcher',
    ...
    skills: [
      ...
      { id: 'rally_bell', name: 'Rally Bell', type: 'command', systemType: 'Universal', cost: 2, description: 'Summon support. -30 Corruption, +12 Stability.', shortEffect: 'Command • -30 Corruption · +12 Stability', rpgDescription: 'A silver bell summons nearby healers to steady the crisis.', beginnerExplanation: 'Call for help when the situation is getting worse — a coordinated response hits harder.', nclexExplanation: 'Escalation is appropriate when patient status is unstable, worsening, or beyond what can be safely managed alone. A timely call directly reduces disease burden.', strike: 30, stabilize: 12 },
    ],
  },
  {
    id: 'apprentice_seer',
