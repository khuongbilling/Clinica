...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    bondExp: 0,
    skills: [
      { id: 'safety_circle', name: 'Safety Circle', type: 'shield', systemType: 'Protection', cost: 1, description: 'Reduce the next direct enemy attack\'s Stability damage by 50%. Only blocks that one hit — Corruption growth, passive disease spread, and scripted boss effects continue unaffected.', shortEffect: 'Shield • −50% next direct attack', rpgDescription: 'A protective circle prevents harm before it reaches the patient.', beginnerExplanation: 'Stop a dangerous event before it happens.', nclexExplanation: 'Patient safety includes fall prevention, medication safety, infection prevention, and reducing avoidable harm.', shield: 50 },
      { id: 'isolation_seal', name: 'Isolation Seal', type: 'command', systemType: 'Protection', cost: 2, description: 'Block the next direct attack (Shield 100%), halt Corruption spread from the enemy\'s next spread assault, and counter infection for −10 Corruption (vs Fire). Unlike basic shields, this also directly fights the disease.', shortEffect: 'Counter • Block attack · Halt Spread · −10 Corruption', rpgDescription: 'A seal of protection seals off the infectious source and strikes at the corruption causing it.', beginnerExplanation: 'Stop germs from spreading AND help fight the infection.', nclexExplanation: 'Source control and transmission prevention directly reduce the infectious disease burden — isolation is not just defensive, it is a treatment.', blockSpread: true, shield: 100, strike: 10 },
    ],
  },
  {
    id: 'data_acolyte',
  ...
  },
  {
    ...
    skills: [
      { id: 'skin_shield', name: 'Skin Shield', type: 'shield', systemType: 'Protection', cost: 1, description: 'Reduce the next direct enemy attack\'s Stability damage by 45%. Only blocks that one hit — Corruption growth, passive disease spread, and scripted boss effects continue unaffected.', shortEffect: 'Shield • −45% next direct attack', rpgDescription: 'A weave of healing knits the barrier before harm arrives.', beginnerExplanation: 'Protect the skin and body from harm.', nclexExplanation: 'Maintain skin integrity through positioning, pressure relief, and barrier care to prevent breakdown.', shield: 45 },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'error_ward', name: 'Error Ward', type: 'shield', systemType: 'Protection', cost: 2, description: 'Fully block the next direct enemy attack — that hit deals zero Stability damage. Does not block Corruption spread, passive deterioration, or scripted boss effects.', shortEffect: 'Shield 100% • Fully block next direct attack', rpgDescription: 'A warning rune flares and absorbs the next blow entirely.', beginnerExplanation: 'Fully shield the patient from the next hit.', nclexExplanation: 'Nurses must recognize unsafe orders, contraindications, and interventions that could worsen the patient.', shield: 100 },
    ],
  },
];
...
export const ENEMIES: Enemy[] = [
  ...
  // ── Chapter 4 enemies — Code Rush / Priority (difficulty 4) ─────────────
  {
    ...
    dangerTrigger: 'Priority collapse — wrong patient treated first',
  ...
  },
  {
    ...
    dangerTrigger: 'System failure — resource collapse under pressure',
