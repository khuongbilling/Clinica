...
export const HEROES: Hero[] = [
  {
    ...
    skills: [
      { id: 'breath_of_dawn', name: 'Breath of Dawn', type: 'stabilize', systemType: 'Air', cost: 1, description: 'Restore oxygenation. +20 Stability, -12 Corruption (Air).', shortEffect: 'Air Treatment • +20 Stability · -12 Corruption', rpgDescription: 'A bright breath restores oxygen flow to the fading Air Crystal, pushing back the respiratory corruption.', beginnerExplanation: 'This supports breathing and oxygen — directly fighting the airway problem.', nclexExplanation: 'Oxygenation support is a direct counter to respiratory distress. Positioning, supplemental oxygen, and airway management reduce the disease burden.', stabilize: 20, strike: 12 },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'isolation_seal', name: 'Isolation Seal', type: 'command', systemType: 'Protection', cost: 2, description: 'Stop spread and counter infection. Shield 100%, -15 Corruption (vs Fire).', shortEffect: 'Protection Counter • Stop Spread · -15 Corruption', rpgDescription: 'A seal of protection seals off the infectious source and strikes at the corruption causing it.', beginnerExplanation: 'Stop germs from spreading AND help fight the infection.', nclexExplanation: 'Source control and transmission prevention directly reduce the infectious disease burden — isolation is not just defensive, it is a treatment.', shield: 100, strike: 15 },
    ],
  },
  {
    id: 'data_acolyte',
  ...
  },
  {
    ...
    skills: [
      { id: 'guardians_touch', name: "Guardian's Touch", type: 'support', systemType: 'Universal', cost: 1, description: 'Steady support. +15 Stability, -8 Corruption.', shortEffect: 'Universal Treatment • +15 Stability · -8 Corruption', rpgDescription: 'A steadying pulse of healing energy restores balance and gently pushes back the corruption.', beginnerExplanation: 'Basic care helps the patient feel better and slowly fights the problem.', nclexExplanation: 'Fundamental nursing care — repositioning, hygiene, comfort measures, and basic monitoring — has a real therapeutic effect that reduces disease burden over time.', stabilize: 15, strike: 8 },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'mend', name: 'Mend', type: 'strike', systemType: 'Protection', cost: 1, description: 'Wound treatment. +18 Stability, -20 Corruption.', shortEffect: 'Protection Treatment • +18 Stability · -20 Corruption', rpgDescription: 'Patient hands cleanse and close what was torn — the corruption loses its foothold.', beginnerExplanation: 'Treating the wound directly fights the problem causing harm.', nclexExplanation: 'Wound care is an active treatment: debridement, dressing changes, and infection control directly reduce the disease process and promote tissue recovery.', stabilize: 18, strike: 20 },
    ],
  },
  {
    id: 'mindkeeper',
    ...
    skills: [
      { id: 'mind_anchor', name: 'Mind Anchor', type: 'cleanse', systemType: 'Mind', cost: 1, description: 'Cleanse status effects + stabilize 10. De-escalation reduces Mind Corruption (-18).', shortEffect: 'Mind Treatment • +10 Stability · -18 Corruption', rpgDescription: 'A steady voice anchors the patient — and the corruption of confusion loses its grip.', beginnerExplanation: 'Calming the patient actively fights Mind-type disease processes.', nclexExplanation: 'Therapeutic communication and de-escalation are active clinical interventions — they directly reduce the neurological and psychological disease burden in delirium and mental health crises.', cleanse: true, stabilize: 10, strike: 18 },
