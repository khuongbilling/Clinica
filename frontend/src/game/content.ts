...
export const HEROES: Hero[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'mythic_prescience', name: 'Mythic Prescience', type: 'scout', systemType: 'Universal', cost: 1, description: 'Intuition beyond training. Reveal 2 clues. -35 Corruption.', shortEffect: 'Scout • Reveal 2 Clues · -35 Corruption', rpgDescription: 'The Prodigy reads the patient in an instant, seeing through every hidden detail at once.', beginnerExplanation: 'Instantly reveals hidden clues and strikes the enemy with mythic force.', nclexExplanation: 'Expert clinical intuition: pattern recognition from thousands of cases allows immediate identification of every critical cue others would miss.', reveal: 2, strike: 35 },
