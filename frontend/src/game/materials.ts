...
const REALM_MATERIALS: MaterialDef[] = [
  ...
  { id: "spirit_stone", name: "Spirit Stone", icon: "diamond-outline", category: "realm", rarity: "uncommon", kind: "power",
    ...
    usedFor: "Building construction and upgrades.", relatedMode: "Realm", status: "active" },
  { id: "sterile_kits_realm", name: "Sterile Kit Bundles", icon: "medkit", category: "realm", rarity: "common", kind: "power",
    ...
    note: "Bulk Realm construction supply — distinct from the single Sterile Kit used for Clinical Supplies equipment upgrades." },
...
const UNI_PRACTICE_MATERIALS: MaterialDef[] = [
  { id: "cue_scroll", name: "Cue Scroll", icon: "eye-outline", category: "player_class", rarity: "common", kind: "learning",
    ...
    usedFor: "Assess/cue-recognition upgrades and future hero ability development (J4+).",
  ...
  { id: "care_chain_manual", name: "Care Pathway Manual", icon: "reader-outline", category: "player_class", rarity: "rare", kind: "learning",
    source: "Advanced Rapid Triage Hall, Advanced Stabilize Stack Lab, practice milestones (10-completion), University Shop (125 UC).",
    usedFor: "Care Pathway upgrade support and future hero Clinical Arts development (J4+).",
