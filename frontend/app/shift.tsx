...
const styles = StyleSheet.create({
  ...
  lead: { color: COLORS.onSurfaceSecondary, fontSize: 15, lineHeight: 23, fontStyle: "italic", marginBottom: SPACING.xs },
  ...
  eventTitle: { color: COLORS.onSurface, fontSize: 18, fontWeight: "700" },
  eventPreviewBadge: { backgroundColor: COLORS.brand + "22", borderRadius: RADIUS.pill, paddingHorizontal: 7, paddingVertical: 2 },
  eventPreviewBadgeTxt: { color: COLORS.brand, fontSize: 12, fontWeight: "700", letterSpacing: 0.3 },
  eventSub: { color: COLORS.onSurfaceSecondary, fontSize: 14, lineHeight: 20, marginTop: 2 },
  ...
  questStickerTxt: { color: COLORS.brand, fontSize: 13, fontWeight: "700", letterSpacing: 0.3 },
  questBadge: {
