...
const CATEGORIES: CategorySection[] = [
  {
    ...
    entries: [
      ...
      {
        id: "clinical_cue_intro",
        icon: "help-circle-outline",
        title: "Clinical Cues",
        subtitle: "Mid-battle diagnostic questions",
        body: "A Clinical Cue is a real question about your patient's active condition that appears mid-battle. Answer it before acting — a correct answer restores AP and boosts every stabilizing action you take that turn. Incorrect answers have no penalty.",
        bullets: [
          "Answer before using any skills for the full bonus",
          "Correct answers restore AP and boost stabilization this turn",
          "Cue topics match the enemy's active clinical domain",
        ],
        accentColor: "#22D3EE",
        status: "available",
        tutorialId: "clinicalCueIntro",
        replayRoute: "/shift",
        practiceRoute: "/shift",
        practiceLabel: "Enter Ward Shift",
      },
      {
        id: "affinity_match_intro",
        icon: "git-branch-outline",
        title: "Treatment Affinity",
        subtitle: "Match your treatment to the clinical domain",
        body: "After a skill resolves, the battle log may show 'Affinity advantage' or 'Weak affinity'. Affinity advantage means your treatment aligns with the patient's active clinical domain and hits harder. Weak affinity means it does not and is less effective.",
        bullets: [
          "Use Assess first to reveal the active clinical domain",
          "Match your treatment type to the revealed domain for bonus effect",
          "Check the Compendium for the full domain reference",
        ],
        accentColor: "#A78BFA",
        status: "available",
        tutorialId: "affinityMatchIntro",
        replayRoute: "/shift",
        practiceRoute: "/shift",
        practiceLabel: "Enter Ward Shift",
      },
