...
const styles = StyleSheet.create({
  ...
  enemyKicker: { color: COLORS.error, fontSize: 11, letterSpacing: 0.8, fontWeight: "700" },
  ...
  barLabel: { color: COLORS.onSurfaceTertiary, fontSize: 11, letterSpacing: 0.3, fontWeight: "700", width: 60 },
  ...
  clueDetail: { color: COLORS.onSurfaceTertiary, fontSize: 12, lineHeight: 16 },
  ...
  tabTxt: { color: COLORS.onSurfaceTertiary, fontSize: 11, fontWeight: "700", letterSpacing: 0.3 },
  ...
  passiveLbl: { color: COLORS.brand, fontSize: 11, fontWeight: "700", letterSpacing: 0.5 },
  ...
  detailSection: { color: COLORS.onSurfaceTertiary, fontSize: 11, letterSpacing: 0.5, fontWeight: "700", marginTop: 8 },
  ...
  ultBtnTxt: { color: "#1A1200", fontSize: 11, fontWeight: "700" },
  ...
  cueRationaleLabel: { color: COLORS.runeGold, fontSize: 11, letterSpacing: 0.5, fontWeight: "700", marginBottom: 3 },
  ...
  cueRewardLabel: { color: COLORS.onSurfaceTertiary, fontSize: 11, letterSpacing: 0.5, fontWeight: "700", marginBottom: 2 },
  ...
  briefingClinicaKicker: { color: COLORS.brand, fontSize: 11, letterSpacing: 0.8, fontWeight: "700", marginBottom: 4 },
  ...
  briefingFocusLabel: { color: COLORS.brand, fontSize: 11, letterSpacing: 0.8, fontWeight: "700", marginBottom: 2 },
  ...
  briefingKicker: { color: COLORS.brand, fontSize: 11, letterSpacing: 1, fontWeight: "700" },
  ...
  briefingColLabel: { color: COLORS.onSurfaceTertiary, fontSize: 11, letterSpacing: 0.5, fontWeight: "700" },
  ...
  briefingGoalsTitle: { color: COLORS.onSurfaceTertiary, fontSize: 11, letterSpacing: 0.5, fontWeight: "700", marginBottom: 8 },
